...
//View
    ...
    var recordingControlButtonsContainer;
    var stopRecordingButton;
    var cancelRecordingButton;
    var elapsedTimeTag;
    var closeBrowserNotSupportedBoxButton;
    var overlay;
    var audioElement;
    ...
    return(
        <div>
            <div className="audio-recording-container">
                ...
                <i className="start-recording-button fa fa-microphone" aria-hidden="true">Start</i>
                <div className="recording-contorl-buttons-container hide">
                    ...
                    <i className="stop-recording-button fa fa-stop-circle-o" aria-hidden="true">Stop</i>
                </div>
